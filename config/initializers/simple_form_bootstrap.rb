...
SimpleForm.setup do |config|
  ...
  config.wrappers :floating_labels_form, tag: 'div', class: 'form-floating', error_class: 'form-floating-invalid', valid_class: 'form-floating-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # custom multi select
  config.wrappers :floating_labels_select, class: 'form-floating mb-3', error_class: 'form-floating-invalid', valid_class: 'form-floating-valid' do |b|
    b.use :html5
    b.optional :readonly
