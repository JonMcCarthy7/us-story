...
ActiveRecord::Schema.define(version: 2021_12_16_055232) do
  ...
  create_table "rems", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["entry_id"], name: "index_rems_on_entry_id"
    t.index ["user_id"], name: "index_rems_on_user_id"
  end
  ...
  add_foreign_key "rems", "entries"
  add_foreign_key "rems", "users"
